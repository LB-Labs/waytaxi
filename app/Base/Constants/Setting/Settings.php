...
class Settings
{
    ...
    const ENABLE_MOYASAR='enable-moyasar';
    const MOYASAR_ENVIRONMENT='moyasar-environment';
    
    const MOYSAR_TEST_PUBLISHABLE_KEY='moyasar_test_publishable_key';
    const MOYSAR_TEST_SECRET_KEY='moyasar_test_secret_key';
    const MOYASAR_LIVE_PUBLISHABLE_KEY='moysar_live_publishable_key';
    const MOYASAR_LIVE_SECRET_KEY='moysar_live_secret_key';
